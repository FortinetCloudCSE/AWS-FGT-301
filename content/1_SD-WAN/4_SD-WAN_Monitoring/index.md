...
linkTitle: "Section 4: SD-WAN Monitoring"
chapter: false
weight: 4
---
...
In the same screen, you can click on the **"History View"** to see the traditional SD-WAN monitor view. Here you can see (scroll all the way to the bottom to see everything):

- SD-WAN Interfaces
- SD-WAN Rules with selected Member (green check mark in members section of each rule)
...
Since FAZ features have been enabled on this FMG, the FAZ Views are now available in the FMG Console.
...
- DIA traffic getting steered out of **'port1'** via SD-WAN Rule #1 named **'DIA'**.
