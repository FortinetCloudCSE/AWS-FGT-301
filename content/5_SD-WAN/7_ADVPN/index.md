...
1. Navigate to the **EC2 Console** and connect to **scw-region1-branch1-linux-instance** using the **[Serial Console directions](../6_cloudwan)** 
  - Password: **`FORTInet123!`**
2. Start a ping and leave it running to **scw-region2-branch-2-linux-instance**. Don not stop the ping as we will need this traffic for this section and the next section of the workshop.
  - `ping 10.48.0.46`
...
Branch1 now has a dynamic **BGP route** to the Branch2 network ** 10.48.0.32/28** pointing to the shortcut tunnel **HUB1-VPN1_0**.
...
{{% notice tip %}}
TODO... Maybe I need to allow certain traffic between the FMGs and all other FGTs except for Hub1? Hub1 is the only one that shows up here in FortiView or in the logs.
{{% /notice %}}
