...
{{% notice tip %}}
SDWAN CSEs, if you all know how to keep the Branch FGTs cordinates from being overwritten by the EIP's cordinates, that would be greatly appreciated!

If the Branch FGTs are showing in different locations that can be addressed with updating the device settings. In ***FMG > Device Manager > Device & Groups > Managed FortiGate*** Right click either Branch FGT and select edit. In the **Geographic Cordinate** section, click **Show Map**. Then on the next page enter the following cordinates for the Branch FGTs and click **OK twice** to save the cordinates:

FGT | Lattitude | longitude
--|--|--
Branch1 | 32.4 | -92.2
Branch2 | 35.2 | -90
...
- You can enlarge each section by clicking on the pop-out icon in the upper right-hand corner, scroll down for this widget.
