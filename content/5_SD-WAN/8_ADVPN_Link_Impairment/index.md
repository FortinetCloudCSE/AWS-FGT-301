...
{{% notice tip %}}
TODO... Currently when I enable impairment on port1 of the Branch FGTs with the vyos router giving a little over 200ms of delay, the connection between the Branch FGT and FMG breaks and all the network monitors and even sdwan monitor will hang. So I need to play around with this setup to still trigger impairment in port1 that will not cause this issue. Right now I am triggering impairment on port2 for the Branch FGTs.

That said, this section of the workshop is not going to work.

If anyone knows what the sweet spot is for 7.6.6 FMG and FGT, please let me know.
{{% /notice %}}
